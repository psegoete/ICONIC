                        ...
                        <form method="POST" action="{{ route('packages.update', $package->id) }}">
                            ...
                            <div class="form-group{{ $errors->has('package_name') ? ' has-error' : '' }}">
                                ...
                                <input id="package_name" type="text"
                                       ...
                                       name="package_name"
                                       value="{{ old('package_name', $package->package_name) }}"  autofocus>
                             ...
                             <div class="form-group{{ $errors->has('package_description') ? ' has-error' : '' }}">
                                ...
                                <input id="package_description" type="text"
                                       ...
                                       value="{{ old('package_description', $package->package_description) }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <input id="price" type="text"
                                       ...
                                       name="price"
                                       value="{{ old('price', $package->price) }}" required autofocus>
