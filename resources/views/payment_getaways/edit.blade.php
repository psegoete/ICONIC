...
<li class="breadcrumb-item">
    <a href="{{ route('payments.index') }}"> Payment getways</a>
</li>
<li class='breadcrumb-item active'>Edit payment getway</li>
@endsection
        ...
        <div class="clearfix">
            <div class="card">
                <div class="card-header">
                    <strong>Create payment getway</strong> 
                ...
                @endif
                <div class="card-body">
                        <form method="POST" action="{{ route('payments.update', $payment_getaway->id) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
