        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    @endnotsubscribed
                    <li class="nav-item">
                        <a class="nav-link{{ return_if(on_page('tickets.index') or on_page('tickets.create'), ' active') }}" href="#navbar-tickets" data-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="navbar-forms">
                        ...
                        <div class="collapse" id="navbar-tickets">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link{{ return_if(on_page('tickets.index'), ' active') }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link{{ return_if(on_page('tickets.create'), ' active') }}"
