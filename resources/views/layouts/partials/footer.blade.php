        ...
        <div class="modal-dialog modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('saas/img/logo.png') }}" width="160" alt="logo"></a>
                        ...
                        <div class="container register">
                                <div class="row">
                                    <div class="col-md-3 register-left">
                                        <img src="https://image.ibb.co/n7oTvU/logo_white.png" alt="" style="height: 25px"/ >
                                        <h3>Welcome</h3>
