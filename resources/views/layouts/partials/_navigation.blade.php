...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('saas/img/ICD_Logo_PNG_1000px.png') }}" alt="logo" style="height: 80px; wedth: 200px"></a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            {{-- <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}#slider">Home</a>
                </li>
                <li class="nav-item">
