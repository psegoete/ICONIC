    ...
    <div style="margin-left: 5px; margin-right: 5px;margin-top: 25px;">
        <div style="background-color:white;margin-left: 5px; margin-right: 5px;margin-top: 25px;margin-bottom: 25px">
            ...
            <p style="margin-left: 6px" align="center">
                        <a href="https://portal.eagletunedinternational.com/download/file_service/{{ $data['id'] }}" style="color: #fff;
            ...
            <p style="margin-left: 6px">
                If you did not request file service, no further action is required.
            </p>
            <p style="margin-left: 6px">
                Kind regards,
            </p>
...
MAIL_USERNAME="noreply@iconiccodedevelopment.com"
MAIL_PASSWORD="hNvD+^;rFMbF"

MAIL_USERNAME="iconiccodedevelopment@iconiccodedevelopment.com"
MAIL_PASSWORD="R]GQdAxd7_BT"