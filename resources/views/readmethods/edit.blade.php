...
<li class='breadcrumb-item active'>Edit read method</li>
@endsection
        ...
        <div class="clearfix">
            <div class="card">
                <div class="card-header">
                    <strong>Edit read method</strong> 
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('readmethods.update', $readmethod->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                            <div class="form-group{{ $errors->has('read_method_name') ? ' has-error' : '' }}">
                                <label class="col-form-label" for="read_method_name">Name <span class="text-danger">*</span></label>
                                    <input type="text" id="read_method_name" name="read_method_name" class="form-control{{ $errors->has('read_method_name') ? ' is-invalid' : '' }} "
                                        ...
                                        value="{{ old('read_method_name', $readmethod->read_method_name) }}">
