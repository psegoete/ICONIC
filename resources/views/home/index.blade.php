            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <table class="table table-responsive-sm table-striped">
                        ...
                        <tbody>
                            @foreach($company_credits as $company_credit)
                            <tr>
                                <td>{{ $company_credit->credits }} credits</td>
                                <td>R {{ number_format($company_credit->from, 2) }}</td>
                                <td>R {{ number_format($company_credit->for,2) }}</td>
                                <td>{{ $company_credit->for / $company_credit->from * 100 }} %</td>
                            </tr>
                            @endforeach
                        </tbody>
