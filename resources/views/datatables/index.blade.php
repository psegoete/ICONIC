...
<form name="userForm" action="{{ route('datatables.store') }}" method="POST">
...
<a href="{{ route('datatables.index') }}" class="btn btn-danger">Cancel</a>
</div>
</div>
</form>
</div>
...
<tr><td></td><td style="text-align: right "><a href="{{ route('datatables.index') }}" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
