...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'checkrole' => \CreatyDev\Http\Middleware\CheckRole::class,
        'adminrights' => \CreatyDev\Http\Middleware\AdminRights::class,
        'customerrights' => \CreatyDev\Http\Middleware\CustomerRights::class,
        'subscription' => \CreatyDev\Http\Middleware\Subscription::class,
        'CheckCompany' => \CreatyDev\Http\Middleware\CheckCompany::class,
        'blockUser' => \CreatyDev\Http\Middleware\blockUser::class,
        'blockCompany' => \CreatyDev\Http\Middleware\blockCompany::class,
        'jwt.verify' => \CreatyDev\Http\Middleware\JWTMiddleware::class,
    ];
}
